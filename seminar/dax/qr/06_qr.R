# Week 6: Forecast DAX returns using a Quantile Regression model
...
# settings
week = 6
forecast_date <- as.Date("2023-12-20") 
...
data$horizon <- paste(c(1, 2, 7), "day")
