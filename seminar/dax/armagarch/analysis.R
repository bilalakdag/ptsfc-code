...
# for (i in 1:12) {
#     # name <- paste0("week", i)
#     path <- paste0("seminar//dax//armagarch//results//daxAG_subQuantiles_week", i, ".csv")
#     tmp <- read.csv(path)
...
print(
    xtable(x = scores,
            type = "latex", 
            digits = 2, 
            label = "dax_armagarch_qs",
            caption = "Quantile scores for predicted DAX returns using ARMA-GARCH. 
                       Averaged over the 12 weeks relevant for the challenge."),
    include.rownames = FALSE,
    file = "seminar/dax/armagarch/armagarch_mean_qs.latex")
...
print(
    xtable(x = coverage,
            type = "latex", 
            digits = 2, 
            label = "dax_armagarch_coverage",
            caption = "Coverage probability for predicted DAX returns using ARMA-GARCH. "),
    # include.rownames = FALSE,
    file = "seminar/dax/armagarch/armagarch_coverage.latex")
...
cumLogReturnGARCH <- quantiles_forplot %>%
...
ggsave("seminar/dax/armagarch/cumulative_log_returns_ag.pdf", plot = cumLogReturnGARCH)
