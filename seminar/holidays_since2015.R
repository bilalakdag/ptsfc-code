...
holidays <- c(german_holidays(2015),german_holidays(2016),german_holidays(2017), german_holidays(2018),
                     german_holidays(2019), german_holidays(2020), german_holidays(2021),
...
saveRDS(holidays, "seminar/holidays_since2015.RDS")
write.csv(holidays, "seminar/holidays_since2015.csv", row.names = FALSE, col.names = FALSE)